...
def main():
    ...
    parser.add_argument("--train_path", type=str, default='../densevid_eval/yc2_data/yc2_train_anet_format.json')
    parser.add_argument("--dset_name", type=str, default="yc2", choices=["anet", "yc2"])
    parser.add_argument("--cache", type=str, default="./cache")
    parser.add_argument("--min_word_count", type=int, default=3)
    parser.add_argument("--raw_glove_path", type=str, default='/mnt/Video_feature/path/glove.6B.300d.txt')
    ...
    word2idx_path = os.path.join(opt.cache, "{}_word2idx_3.json".format(opt.dset_name))
    save_json(word2idx, word2idx_path, save_pretty=True)
    print("[Info] Finish.")

    vocab_glove_path = os.path.join(opt.cache, "{}_vocab_glove_3.pt".format(opt.dset_name))
